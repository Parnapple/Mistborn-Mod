...
public enum OreFeature {
    ...
    CADMIUM("cadmium_ore", 5, 15, 10, -60, ModBlocks.CADMIUM_ORE.get(), ModBlocks.DEEPSLATE_CADMIUM_ORE.get()),
    CHROMIUM("chromium_ore", 9, 15, 10, -50, ModBlocks.CHROMIUM_ORE.get(), ModBlocks.DEEPSLATE_CHROMIUM_ORE.get()),
    ALUMINUM("aluminum_ore", 1, 50, 200, 60, List.of(
            OreConfiguration.target(OreGeneration.DIRT_TEST, ModBlocks.BAUXITE_ORE.get().defaultBlockState()))),
    SILVER("silver_ore", 9, 8, 10, -30, ModBlocks.SILVER_ORE.get(), ModBlocks.DEEPSLATE_SILVER_ORE.get()),
    LEAD("lead_ore", 7, 20, 70, -10, ModBlocks.LEAD_ORE.get(), ModBlocks.DEEPSLATE_LEAD_ORE.get()),
    BISMUTH("bismuth_ore", 10, 15, 35, -25, ModBlocks.BISMUTH_ORE.get(), ModBlocks.DEEPSLATE_BISMUTH_ORE.get()),
    NICKEL("nickel_ore", 9, 15, 70, -10, ModBlocks.NICKEL_ORE.get(), ModBlocks.DEEPSLATE_NICKEL_ORE.get());
    ...
    OreFeature(String name, int size, int count, int maxHeight, int minHeight, List<OreConfiguration.TargetBlockState> targets) {
        ...
        PlacementUtils.register(name + "_placed",
