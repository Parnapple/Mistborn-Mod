...
public class MistagerCopperEntity extends Mistager {


    public MistagerCopperEntity(EntityType<? extends AbstractIllager> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
            ...
            this.goalSelector.addGoal(0, new EatMetalBeadGoal(this,(MetalBeadItem) ModItems.COPPER_BEAD.get()));
            this.goalSelector.addGoal(1, new CopperCloudGoal(this));
    ...
    protected static class CopperCloudGoal extends Goal {
        private final Mistager mob;

        public CopperCloudGoal(Mistager pMob) {
            this.mob = pMob;
        }

        public boolean canUse() {
            return mob.metalStores > 0 && !mob.getOffhandItem().getItem().equals(ModItems.COPPER_BEAD.get());
        }
